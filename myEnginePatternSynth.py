...
from myEngine import MyEngine  # This is "event" synthesizer this pattern synth will use

################################################################################################################
class MyEnginePatternSynth(SI.MySoundModel) :

	def __init__(self, cf=40, Q=10, rate_exp=0, irreg_exp=1) :
